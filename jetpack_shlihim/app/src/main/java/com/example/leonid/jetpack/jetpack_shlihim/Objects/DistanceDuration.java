...
public class DistanceDuration {
    ...
    public void start_duration_exec(  LatLng origin,  LatLng dest ,RouteCalculation callback_activity,Boolean update_db_after_assign,int size,Delivery to_assign_delivery
...
//                a++;
                ...
                count++;
                setDuration(999);
                Toast.makeText(ac.getContext(), "שים לב כי חישוב זמן אינו נכון, ייתכן כי השליח לא הפעיל את שרותי המיקום", Toast.LENGTH_LONG).show();
//                if (a >= 5)
//                {
//                    return;
//                }
                ...
                {
                    count = 0;
                    ac.callCallback(update_db_after_assign,to_assign_delivery,update_delivery_guy_with_moved_delivery,index_index_update_Delivery_guy);
                }
